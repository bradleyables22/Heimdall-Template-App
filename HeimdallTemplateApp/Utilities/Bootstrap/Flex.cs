...
namespace HeimdallTemplateApp.Utilities
{
    public static partial class Bootstrap
    {
        ...
        public static class Flex
        {
            ...
            /// <summary>
            /// Returns the CSS flex direction class name for the specified direction and optional breakpoint.
            /// </summary>
            ...
            /// <returns>A string containing the CSS class name representing the flex direction, optionally prefixed with the
            /// specified breakpoint.</returns>
            ...
            /// <summary>
            /// Generates a CSS flexbox wrap mode class name based on the specified wrap kind and optional breakpoint.
            /// </summary>
            /// <param name="wrap">The flex wrap mode to use when generating the class name. Must be a valid value of the FlexWrapKind
            /// enumeration.</param>
            /// <param name="bp">The optional breakpoint at which the wrap mode should apply. If not specified, the class name is
            /// generated without a breakpoint prefix.</param>
            /// <returns>A string containing the CSS class name representing the specified flex wrap mode, optionally prefixed
            /// with the breakpoint. For example, "flex-wrap" or "flex-md-wrap-reverse".</returns>
            /// <exception cref="ArgumentOutOfRangeException">Thrown if the value of wrap is not a valid member of the FlexWrapKind enumeration.</exception>
            ...
            /// <summary>
            /// Generates a CSS class name for the specified justify-content alignment, optionally including a
            ...
            /// <param name="bp">The responsive breakpoint to include as a prefix in the CSS class name. Use Breakpoint.None to omit the
            /// prefix.</param>
            /// <returns>A string containing the CSS class name representing the specified justify-content alignment and optional
            /// breakpoint prefix.</returns>
            /// <exception cref="ArgumentOutOfRangeException">Thrown if the value of justify is not a valid JustifyContentKind enumeration value.</exception>
            ...
            /// <summary>
            /// Generates a CSS class name for the 'align-items' property based on the specified alignment and optional
            /// responsive breakpoint.
            /// </summary>
            /// <param name="align">The alignment option to use for the 'align-items' CSS property. Must be a valid value of the
            /// AlignItemsKind enumeration.</param>
            /// <param name="bp">An optional responsive breakpoint at which the alignment should apply. Defaults to Breakpoint.None,
            /// indicating no breakpoint.</param>
            /// <returns>A string containing the CSS class name representing the specified 'align-items' alignment, optionally
            /// scoped to the given breakpoint.</returns>
            /// <exception cref="ArgumentOutOfRangeException">Thrown if align is not a valid value of the AlignItemsKind enumeration.</exception>
